...
const About = () => {
  return (
    <section className="body-font bg-white dark:bg-gray-900 -mt-4">
      <div className="p-5 pt-8 mx-auto md:pt-10 md:mx-10 lg:mx-16">
          ...
          <div className="lg:w-1/2 justify-center lg:p-5 xl:p-7 md:p-5 flex flex-col items-center text-justify">
            {AboutData.description?.map((item, index) => (
              <p
                ...
                data-aos-duration="1000"
                data-aos-once="false"
                className="font-medium text-gray-700 dark:text-gray-300 text-lg lg:text-base xl:text-xl leading-loose xl:leading-8 mb-4"
              >
                {item}
              </p>
            ))}
