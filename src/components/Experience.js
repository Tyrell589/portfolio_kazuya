            ...
            return isLeft ? (
              ...
              >
                <div
                  ...
                  data-aos-once="false"
                  className="bg-slate-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 col-start-1 col-end-5 p-2.5 md:p-4 rounded-lg my-4 ml-auto shadow-md"
                >
                  <h3 className="text-lg md:text-xl font-semibold mb-1">
                    {exp.title}
                  </h3>
                  <div className="flex flex-col md:flex-row md:items-center justify-between font-medium w-full gap-2 mb-2">
                    <h4 className="text-base text-gray-500 dark:text-gray-400">{exp.company}</h4>
              ...
              <div key={index} className="flex md:contents text-start">
                ...
                <div
                  ...
                  data-aos-duration="1500"
                  data-aos-once="false"
                  className="bg-slate-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 col-start-6 col-end-10 p-2.5 md:p-4 rounded-lg my-4 mr-auto shadow-md"
                >
                  <h3 className="text-lg md:text-xl font-semibold mb-1">
                    {exp.title}
                  </h3>
